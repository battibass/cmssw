...
namespace edm
{
  namespace refhelper
  {
    template< typename IndexType, typename DigiType > class FindForMuonDigiCollection : 
      public std::binary_function< const MuonDigiCollection< IndexType, DigiType >&, 
      std::pair< IndexType, typename std::vector< DigiType >::size_type >, const DigiType* >
    {
    public:
	  ...
	  typename Self::second_argument_type iIndex ) const
      {
