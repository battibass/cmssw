...
class IsolatedTrackRekeyer : public edm::stream::EDProducer<> {
private:
...
public:
  IsolatedTrackRekeyer(edm::ParameterSet const& params)
  ...
  ~IsolatedTrackRekeyer() override = default;
...
DEFINE_FWK_MODULE(IsolatedTrackRekeyer);
